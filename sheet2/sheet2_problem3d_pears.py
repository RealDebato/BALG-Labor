...
fg_threshold[img_blured>148] = 255
fg_threshold[img_blured<=148] = 0 

fg_threshold = cv2.erode(fg_threshold, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (5, 5))) # Marker verkleinern und glätten
